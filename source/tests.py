...
class Test(unittest.TestCase):
    ...
    def test_rand_long(self):
        ...
        for _ in range(2):
            dfa_rand = random_dfa(["a", "b", "c", "d", "e"], min_states=30, max_states=100, min_final=20,
                                  max_final=30)
        ...
        # Testing regular extraction:
        for _ in range(2):
            dfa_rand1 = random_dfa(["a", "b", "c", "d", "e"], min_states=20, max_states=50, min_final=15,
                                   max_final=20)
            dfa_rand2 = random_dfa(["a", "b", "c", "d", "e"], min_states=20, max_states=50, min_final=15,
                                   max_final=20)
